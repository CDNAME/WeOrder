<template>
  <div class="goods" v-if="seller.data">
    <div class="menu-wrapper" ref="menuWrapper">
      <ul>
        <li v-for="(item,index) in goods.data" @click="selectMenu(index)"
    ...
    <shopcart :select-foods="selectFoods" :deliveryPrice="seller.data.deliveryPrice" :minPrice="seller.data.minPrice"></shopcart>
