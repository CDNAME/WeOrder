<template>
  <div class="header" v-if="seller.data">
    <div class="content-wrapper">
      ...
      <div class="content">
        ...
        <div v-if="seller.data.supports" class="support">
          <span class="icon" v-bind:class="classMap[seller.data.supports[0].type]"></span>
          <span class="text">{{seller.data.supports[0].description}}</span>
        </div>
      </div>
      <div v-if="seller.data.supports" class="support-count" @click="showDetail">
